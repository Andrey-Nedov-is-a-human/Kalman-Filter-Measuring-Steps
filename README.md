...
Так как фильтр Калмана отдаёт нам перемещение, благодаря новым данным, полученным после более глубокого анализа данных с датчиков, мы можем более точно подсчитать пройденное расстояние.
